...
<div class="attendance-page">
        ...
        <div class="header-content">
            <div class="header-title">
                ...
                <div class="title-text">
                    ...
                    <p>إدارة سجلات الحضور والغياب للطلاب</p>
                </div>
            </div>
    ...
    <div class="search-section">
        <form method="GET" action="{{ route('admin.enhanced-attendance.index') }}" class="search-form">
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="{{ route('admin.enhanced-attendance.edit', $record->id) }}" class="btn btn-sm btn-warning">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form method="POST" action="{{ route('admin.enhanced-attendance.destroy', $record->id) }}" style="display: inline;">
                                @csrf
                                @method('DELETE')
